...
fd_set      read_set, write_set, current;//stock fd ready to be read, to accept write and current ??
int         maxfd = 0, gid = 0;//fd max, gid ??
...
int     main(int ac, char **av)
{
    ...
    FD_ZERO(&current);//initialise the fd_set to zero
    FD_SET(serverfd, &current);//add an fd to a fd_set
