...
function fillReturnBody(&$content, array $players, array $names) {
	...
	if (count($winnerS) > 1) {
		...
		$content .= '<div class="winner">🥇 ' . htmlspecialchars(($winner)) . ' is the winner with a score of ' . '<span>' . htmlspecialchars($total_max) . '🥇' . '</span> <img src="/cgi-bin/trophee.png" alt="Trophée" width="80" class="trophy"></div>';
	}
	$content .= '</section>
	</main>
